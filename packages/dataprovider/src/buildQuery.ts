...
export interface QueryBuilderFactory {
  factory: (introspectionResults: IntrospectionResult) => any;
}

export const buildQuery = function(options: OurOptions): QueryBuilderFactory
{
  return {
    factory: (introspectionResults: IntrospectionResult) => {
